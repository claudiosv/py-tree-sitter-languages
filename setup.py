...
setuptools.setup(
    name='tree_sitter_languages2',
    version=version,
    description='Binary Python wheels for all tree sitter languages.',
    long_description=readme,
    author='Grant Jenks',
    author_email='contact@grantjenks.com',
    url='https://github.com/claudiosv/py-tree-sitter-languages',
    license='Apache 2.0',
    ...
    project_urls={
        'Documentation': 'https://github.com/claudiosv/py-tree-sitter-languages',
        'Source': 'https://github.com/claudiosv/py-tree-sitter-languages',
        'Tracker': 'https://github.com/claudiosv/py-tree-sitter-languages/issues',
    },
    classifiers=[
